...
movies_db = {
    "Комедія": [
        {"photo": "photo/comedy1.png", "name": "Суперперці", "description": "Двоє нерозлучних друзів-старшокласників намагаються вразити дівчат перед випуском, потрапляючи у безліч кумедних ситуацій.", "rating": 7.6, "price": 60},
        {"photo": "photo/comedy2.png", "name": "Мачо і Ботан", "description": "Двоє невдалих поліцейських під прикриттям повертаються до школи, щоб викрити наркомережу, і знову переживають підліткові проблеми.", "rating": 7.2, "price": 60},
    ],
    "Драма": [
        {"photo": "photo/drama1.png", "name": "Втеча з Шоушенка", "description": "Несправедливо засуджений банкір проводить роки у в'язниці, зберігаючи надію та плануючи неймовірну втечу.", "rating": 9.3, "price": 60},
        {"photo": "photo/drama2.png", "name": "Зелена миля", "description": "Історія наглядача в блоці смертників в'язниці та його стосунків з незвичайним ув'язненим, що володіє дивовижними здібностями.", "rating": 8.6, "price": 60},
    ],
    "Бойовик": [
        {"photo": "photo/action1.png", "name": "Темний лицар", "description": "Бетмен протистоїть хаотичному генію злочинності - Джокеру, який прагне занурити Готем у анархію.", "rating": 9.0, "price": 60},
        {"photo": "photo/action2.png", "name": "Джон Вік", "description": "Легендарний колишній найманий вбивця повертається зі спокою, щоб помститися гангстерам, які забрали у нього найдорожче.", "rating": 7.4, "price": 60},
    ]
}
